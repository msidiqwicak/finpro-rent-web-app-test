...
router.post("/upload", authenticate, authorizeRole("USER"), uploadPaymentProof.single("image"), verifyBookingOwnership, uploadPaymentProofController);
...
router.post("/snap/:orderId", authenticate, authorizeRole("USER"), createSnapToken);
