...
export const sendVerificationEmail = async (to, token) => {
  ...
  `;
    ...
    if (!sent)
        logMockEmail("SMTP MISSING", to, { Subjek: "Verifikasi", Link: link });
};
export const sendResetPasswordEmail = async (to, token) => {
  ...
  `;
    ...
    if (!sent)
        logMockEmail("SMTP MISSING", to, { Subjek: "Reset Password", Link: link });
};
export const sendEmailChangeVerificationEmail = async (to, token) => {
  ...
  `;
    ...
    if (!sent)
        logMockEmail("SMTP MISSING", to, { Subjek: "Change Email", Link: link });
};
