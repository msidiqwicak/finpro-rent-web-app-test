...
export const groupSalesData = (bookings, groupBy) => {
    ...
    const grouped = bookings.reduce((acc, b) => {
        ...
        if (b.created_at > acc[key].latest_date)
            acc[key].latest_date = b.created_at;
        return acc;
    }, {});
    return Object.values(grouped).map((item) => ({ ...item, date: item.latest_date }));
};
export const sortSalesData = (data, sortBy, sortOrder) => {
...
//# sourceMappingURL=report.helpers.js.map