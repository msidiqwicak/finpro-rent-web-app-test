...
export const createProperty = async (userId, data, files) => {
    const tenantId = await getTenantId(userId);
...
export const updateProperty = async (userId, propertyId, data, files) => {
    const tenantId = await getTenantId(userId);
...
//# sourceMappingURL=property.core.service.js.map