...
import type { PropertyDetail, RoomType } from '../../components/property-detail/types';
...
import { LoadingSkeleton, ErrorState } from '../../components/property-detail/PropertyDetailStates';
  ...
  useEffect(() => {
    ...
    const fetchDetail = async () => {
      try {
        ...
        if (selectedRoom) {
          const updatedRoom = data.room_type?.find((rt: RoomType) => rt.id === selectedRoom.id);
